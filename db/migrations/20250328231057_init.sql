...
DROP POLICY IF EXISTS rls_trips ON trips;
DROP POLICY IF EXISTS rls_stop_times ON stop_times;
DROP POLICY IF EXISTS rls_stops ON stops;
DROP POLICY IF EXISTS rls_routes ON routes;
DROP POLICY IF EXISTS rls_calendar_dates ON calendar_dates;
DROP POLICY IF EXISTS rls_calendar ON calendar;
DROP POLICY IF EXISTS rls_agency ON agency;
DROP POLICY IF EXISTS rls_feed_info ON feed_info;
DROP POLICY IF EXISTS rls_import_metadata ON import_metadata;
...
DROP FUNCTION IF EXISTS default_agency_id;
